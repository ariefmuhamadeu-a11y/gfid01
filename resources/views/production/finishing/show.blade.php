...
@section('title', 'Detail Finishing • ' . $finishingBatch->code)
        ...
        <div class="d-flex align-items-center mb-3">
            ...
            <div class="ms-auto d-flex align-items-center gap-2">
                ...
                @if ($finishingBatch->status !== 'done')
                    <a href="{{ route('production.finishing.edit', $finishingBatch) }}"
            ...
            <div class="card-body py-3">
                <div class="row g-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="help">
                            Total Input:
                            <span class="mono">{{ $finishingBatch->total_qty_input }}</span> pcs
                        </div>
                    </div>

                    <div class="col-md-4">
                        <div class="text-muted small mb-1">Operator & Waktu</div>
                        <div>
                        ...
                        <div class="help">
                            Mulai:
                            {{ optional($finishingBatch->started_at)->format('d/m/Y H:i') ?? '-' }}<br>
                            Selesai:
                            {{ optional($finishingBatch->finished_at)->format('d/m/Y H:i') ?? '-' }}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body py-2">
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <div class="fs-5 mono">{{ $finishingBatch->total_qty_input }}</div>
                    </div>
                    <div class="col-md-4">
                        <div class="text-muted small">Total OK</div>
                        <div class="fs-5 mono text-success">{{ $finishingBatch->total_qty_ok }}</div>
                    </div>
                    <div class="col-md-4">
                        <div class="text-muted small">Total Reject</div>
                        <div class="fs-5 mono text-danger">{{ $finishingBatch->total_qty_reject }}</div>
                    </div>
                </div>
            </div>
        </div>
